...
class StudentFormativeTestOptionFactory extends Factory
{
    private $index = 0;
    public function definition(): array
    {
        ...
        $types = ["quiz","dnd","dnd","check","check","words"];
        $tasks = [
        ...
        return [
            ...
            'test_item_option_id' => $id_test_option,
