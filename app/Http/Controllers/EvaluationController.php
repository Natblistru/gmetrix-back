...
class EvaluationController extends Controller
{
    ...
    public static function store(Request $request) {
        $validator = Validator::make($request->all(), [
            ...
            'type' => 'required|in:Pretestare,Testare de baza,Evaluare suplimentara,Teste pentru exersare1,Teste pentru exersare2,Teste preparatorii,Teste preparatorii2,Teste preparatorii3,Teste preparatorii4',
        ]);
        if ($validator->fails()) {
            return response()->json([
                'status' => 422,
